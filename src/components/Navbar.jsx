  ...
  return (
    <div className="fixed w-full z-30 p-4">
      <div className="w-full h-full flex flex-col items-end">
        ...
        />
        <div
          className={`bg-text absolute top-[4px] h-30 w-56 mt-2 rounded-lg border-yellow-400 border-b-8  navbar-div ${
            isHovered ? "" : "hidden"
          }`}
          onMouseLeave={() => {
            setIsHovered(false);
        ...
        >
          <div className="flex flex-col gap-y-2 p-4 text-base">
            <div
              className="w-[8.5rem] h-full p-2 rounded-lg bg-[#FFCE56] text-background text-center"
              onMouseEnter={(e) => {
            ...
            <a href="mailto:bhat7362@gmail.com" color="black">
              <div
                className="w-[8.5rem] h-full bg-[#FFCE56] text-background p-2 rounded-lg text-center"
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "#deb03e";
                }}
                onMouseLeave={(e) => {
